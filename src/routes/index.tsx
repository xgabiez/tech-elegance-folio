      ...
      <div className="mx-auto max-w-6xl px-4 grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
        <div className="animate-fade-in">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a href={`${import.meta.env.BASE_URL}curriculo/Curriculo_Gabrielly.pdf`}target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-rose/40 px-6 py-3 font-semibold text-rose hover:bg-rose/5 transition">
