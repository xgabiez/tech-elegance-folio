...
const experiences = [
  {
    role: "Analista de TI",
    company: "Centro Educacional Menino Jesus",
    period: "Atual",
    items: [
  ...
  {
    role: "Gestora de TI",
    company: "Escola de Educação Básica",
    period: "Anterior",
    items: [
      "Gestão completa da área de tecnologia",
      "Administração de redes e equipamentos",
      "Gestão de plataformas educacionais",
      "Suporte pedagógico com tecnologia",
